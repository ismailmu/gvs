    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h1 class="box-title">Therapist</h1>
              ...
              <?php
                if (!empty($table))
                {
                  foreach ($table as $row)
                  {
                    ...
                    print_r("<td>". number_format($row->amount) ."</td>");
                    print_r("<td>". $row->amount_duration .' '. $row->amount_unit ."</td>");
                    $flag=($row->is_active == 1)?"checked":"";
                    print_r("<td><input type=\"checkbox\"" . $flag . "></td>");
                    print_r("<td><a href=\"". base_url() . "index.php/therapist/edit/" . $row->id . "\"><i class=\"fa fa-edit\"></i> Edit</a></td>");
                    print_r("</tr>");
                  }
                }
              ?>
...
<script type="text/javascript">
  $(function () {
    ...
    $("#add").click(function() {
      window.location.href='<?php echo base_url(); ?>index.php/therapist/add'
    });
