            ...
            <tbody>
              <?php
                if (!empty($table))
                {
                  ...
                  {
                    print_r("<tr>");
                    print_r("<td>". $row->user_id ."</td>");
                    print_r("<td>". $row->user_name ."</td>");
                    $flag=($row->is_user_logged == 1)?"checked":"";
                    print_r("<td><input type=\"checkbox\"" . $flag . "></td>");
                    print_r("<td>". $row->role_name ."</td>");
                    $flag=($row->gender == 1)?"Male":"Female";
                    print_r("<td>". $flag ."</td>");
                    $flag=($row->is_active == 1)?"checked":"";
                    print_r("<td><input type=\"checkbox\"" . $flag . "></td>");
                    print_r("<td><a href=\"". base_url() . "index.php/user/edit/" . $row->id . "\"><i class=\"fa fa-edit\"></i> Edit</a></td>");
                    print_r("</tr>");
                  }
                }
              ?>
...
<script type="text/javascript">
  $(function () {
    ...
    $("#alert").fadeTo(2000, 500).slideUp(500, function(){
     ...
     $("#add").click(function() {
      window.location.href='<?php echo base_url(); ?>index.php/user/add'
    })
  })
</script>
</body>
